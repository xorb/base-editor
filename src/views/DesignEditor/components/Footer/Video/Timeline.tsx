...
export default function () {
  ...
  React.useEffect(() => {
    let watcher = async () => {
      ...
      // const updatedPreview = (await renderer.render(updatedTemplate, {})) as any
  ...
  const updateCurrentScene = React.useCallback(
    async (design: IScene) => {
      ...
      // const updatedPreview = (await renderer.render(design, {})) as string
      // setCurrentPreview(updatedPreview)
    },
    [editor, currentScene]
  )
  ...
  const addScene = React.useCallback(async () => {
    // setCurrentPreview("")
    // const updatedTemplate = editor.scene.exportToJSON()
    // const updatedPreview = await renderer.render(updatedTemplate, {})
    ...
    // const newPreview = await renderer.render(defaultTemplate, {})
    // const newPage = {
    //   ...defaultTemplate,
    //   id: nanoid(),
    //   preview: newPreview,
  ...
  return (
    <Block $style={{ display: "flex", alignItems: "center", height: "110px" }}>
      <TimelineControl />
      <Block $style={{ display: "flex", flex: 1, height: "110px" }}>
        <Scrollable>
          <div className={css({ display: "flex", alignItems: "center", flex: 1 })}>
            <Block
              id="TimelineItemsContainer"
              $style={{ display: "flex", alignItems: "center", position: "relative", padding: "1rem 0" }}
            >
